      ...
      <div class="container">
         <div class="row">
            ...
            <div  class="col-md-12 hidden-xs">
               ...
               <button type="button" class="btn btn-lg @if($rs->id==$category->id) btn-info @else btn-default @endif btn-category" onclick="gotoCategoryProject('<?php echo ($lang == 'es') ? $rs->url : $rs->url_en ;?>')"><?php echo ($lang == 'es') ? $rs->name : $rs->name_en ;?></button>
               @endforeach
            </div>
...
@endif
<input type="hidden" name="category" id="project_category" value="<?php echo $category->id;?>">
