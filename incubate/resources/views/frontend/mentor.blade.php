   ...
   <div class="container">
      <div class="row">
         ...
         <div  class="col-md-12 hidden-xs">
            ...
            <button type="button" class="btn btn-lg @if($i==1) btn-info @else btn-default @endif btn-category" onclick="gotoCategoryMentor('<?php echo ($lang == 'es') ? $rs->url : $rs->url_en ;?>')"><?php echo ($lang == 'es') ? $rs->name : $rs->name_en ;?></button>
            @endforeach
         </div>
