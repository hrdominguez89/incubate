                  ...
                  <div class="widget z-depth-1">
                     ...
                     <div class="widget-content">
                        ...
                        <div class="input-field col s12">
                           ...
                           {!!Form::text('url_en',$menu->url_en,['id'=>'url_en'])!!}
                        </div>
                        <div class="input-field col s12">
                           <label class="active">Nombre en Inglés<small style="color: #fd2923">*</small></label>
                           {!!Form::text('title_em',$menu->title_en,['id'=>'title_en'])!!}
                        </div>
                                              <div class="input-field col s12">
                           <label class="active">Icono Móvil (24x24px)<small style="color: #fd2923">*</small></label>
                        </div>
                        <div class="input-field col s12 sect-image">
                           <input name="image" id="image" value="{{$menu->image}}" type="hidden">
                           <div id="dropzone" class="dropzone"></div>
                        </div>
                        <br>
                        <div class="col s3 sect-image" ng-repeat="photo in data_photo">
                           <br>
                           <img src="<?php echo url('/');?>/images/@{{photo.nombre}}" alt="Photo" style='width: 70%;display: block;padding: 3px;border: 0.5px solid #ddd;'>
                           <a style="cursor:pointer;font-size: 13px;" ng-click="borrar_image(photo.nombre)" class="red-text"><i class="fa fa-times red-text"></i> Eliminar</a>
                        </div>
                         <div class="input-field col s12">
