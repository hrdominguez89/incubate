            ...
            <div class="col s12">
               <div class="widget z-depth-1">
                 <div class="widget-bar"> 
                  <div class="col s4">
                     <a class="btn orange" href="{{url('mentor/create')}}"> <i class="fa fa-plus-circle" aria-hidden="true"></i> Nuevo Mentor </a>
                  </div>
                  <div class="col s8">
                         ...
                         <thead>
                           ...
                           <tr ng-repeat="row in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                              ...
                              <span class="controls">
                                ...
                                <a href="{{url('/')}}/mentor/@{{row.id}}/edit" class="edituser blue"><i class="ti-pencil-alt"></i> Editar</a>
...
app.controller('paginado', function($scope, $http, $window) {
    //Listar Paginas 
    $scope.rows = function() {
        $http.get("{{url('mentors_lists')}}").then(function successCallback(response)  {
