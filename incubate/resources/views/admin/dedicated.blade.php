...
<div class="content-area">
   <div class="breadcrumb-bar">
      <div class="page-title">
         <h1><i class="ti-briefcase"></i> Dedicación</h1>
      </div>
...
<script type="text/javascript">
  ...
  app.controller('species', function($scope, $http, $window) {
    $scope.titulo = "Nueva dedicación";
    $scope.btn = "Guardar";
    $scope.rows = function() {
      $http.get('{{url("dedicated_lists")}}').then(function successCallback(response)   {
    ...
    $scope.asignarValor = function(id,name,name_en) {
      ...
      $("#name").val(name);
      $("#name_en").val(name_en);
      $scope.titulo = "Actualizá tu dedicación";
      $scope.btn = "Guardar";
    }
  });
  $('#navsm').sortable({
        ...
        update: function() {
            ...
            $.post("{{url('move-dedicated')}}", order, function(theResponse) {
