...
<div class="content-area">
   <div class="breadcrumb-bar">
      <div class="page-title">
         <h1><i class="ti-help-alt"></i> Categorías</h1>
      </div>
...
<script type="text/javascript">
	...
	app.controller('species', function($scope, $http, $window) {
		...
		$scope.btn = "Guardar";
		$scope.rows = function() {
			$http.get('{{url("categories_lists")}}').then(function successCallback(response)   {
	...
	$('#navsm').sortable({
        ...
        update: function() {
            ...
            $.post("{{url('move-categories')}}", order, function(theResponse) {
