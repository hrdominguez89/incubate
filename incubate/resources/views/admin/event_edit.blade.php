               ...
               <div class="col s12">
                  <div class="widget z-depth-1">
                     <div class="widget-title">
                        <h3><i class="ti-pencil"></i> Actualizá la información de tu evento aquí</h3>
                     </div>
                     <div class="widget-content">
                       <div class="input-field col s12">
                           ...
                           <div class="demo">
                              <input type="checkbox" id="c-<?php echo $rs->id;?>" name="categories[]" @if(strpos($event->categories,",".$rs->id)!== false) checked="checked" @endif value="<?php echo $rs->id;?>">
                        ...
                        <div class="tab-content">
                           ...
                           <div id="img-1" class="tab-pane fade in active">
                              ...
                              <div class="input-field col s12"> 
                                 {!! Form::textarea('content',null,['class'=>"materialize-textarea",'cols'=>'5','rows'=>'5','id'=>'editor2']) !!}
                              </div>
                           </div>
                        ...
                        <div class="input-field col s6">
                           <label class="active">Tipo de evento<small style="color: #fd2923">*</small></label>
                            {!!Form::select('type',$type, $event->type, ['data-placeholder' => 'Seleccione','class'=>'browser-default','style'=>'width: 100%'])!!}
                        </div>
                        <div class="input-field col s6">
                           ...
                           <div class="form-group">
                              <div class='input-group date' id='datetimepicker1'>
                                 <input type='text' class="form-control" name="start_date" value="{{date('m-d-Y H:i:s',strtotime($event->start_date))}}" />
                        ...
                        <div class="input-field col s6">
                           ...
                           <div class="form-group">
                              <div class='input-group date' id='datetimepicker2'>
                                 <input type='text' class="form-control" name="end_date" value="{{date('m-d-Y H:i:s',strtotime($event->end_date))}}" />
                                 <span class="input-group-addon">
                                 <i class="ti-calendar"></i>
                                 </span>
                              </div>
                        ...
                        <div class="input-field col s6">
                           <div class="demo">
                              <input type="checkbox" id="demo" name="status_event" @if($event->status_event=='0') checked="checked" @endif value="1">
                     ...
                     <div class="widget-content">
                        ...
                        <div class="input-field col s12 sect-image">
                          <p>Imágenes (740px x 480px)</p>
                           <input name="image" id="image" value="{{$event->image}}" type="hidden">
...
<script type="text/javascript">
   ...
   app.controller('paginas', function($scope, $http) {
     $scope.rows = function() {
       $scope.data = [];
       $http.post("{{url('/')}}/lists-photo-event", {
         'id': <?=$event->id;?>
       })
     ...
     $scope.borrar = function(name) {
       ...
       function() {
         var route = "{{url('delete-photo-event')}}";
         var token = $("#token").val();
         var image = $("#image").val();
         var patron = "," + name;
    ...
    $scope.rows_archives = function() {
        $http.get('<?php echo url('/');?>/events_archives_lists/<?php echo $event->id;?>').then(function successCallback(response) {
