...
<div class="content-area">
   <div class="breadcrumb-bar">
      <div class="page-title">
         <h1><i class="ti-calendar"></i> Tipos de eventos</h1>
      </div>
...
<script type="text/javascript">
	...
	app.controller('species', function($scope, $http, $window) {
		$scope.titulo = "Nuevo tipo";
		$scope.btn = "Guardar";
		$scope.rows = function() {
			$http.get('{{url("types_lists")}}').then(function successCallback(response)   {
      ...
      var name_en = $('#name_en').val();
		...
		$scope.asignarValor = function(id, name,name_en) {
			...
			$("#name").val(name);
      $("#name_en").val(name_en);
			$scope.titulo = "Actualizá tu tipo";
			$scope.btn = "Guardar";
		}
	});
	$('#navsm').sortable({
        ...
        update: function() {
            ...
            $.post("{{url('move-types')}}", order, function(theResponse) {
