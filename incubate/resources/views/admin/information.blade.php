               ...
               <div class="col s12">
                  <div class="widget z-depth-1">
                     <div class="widget-title">
                        <h3><i class="ti-pencil"></i> Ingresá el contenido de tu información aquí</h3>
                     </div>
                  ...
                  <div class="widget z-depth-1">
                     ...
                     <div class="widget-content">
                        <div class="input-field col s12">
                           ...
                           {!!Form::select('type', ['1'=>'Imágenes','2'=>'Video'], 1,['placeholder' => 'Seleccionar el tipo de galería','class' => 'browser-default','id'=>'type'])!!}
                        </div>
