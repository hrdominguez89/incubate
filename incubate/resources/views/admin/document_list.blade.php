...
<div class="content-area">
   <div class="breadcrumb-bar">
      <div class="page-title">
         <h1><i class="ti-settings"></i> Bases y condiciones</h1>
      </div>
            ...
            <div class="col s12">
               <div class="widget z-depth-1">
                 <div class="widget-bar"> 
                  <div class="col s4">
                     <a class="btn orange" href="{{url('documents/create')}}"> <i class="fa fa-plus-circle" aria-hidden="true"></i> Nuevo Documento </a>
                  </div>
                  <div class="col s8">
                         ...
                         <thead>
                           ...
                           <tr ng-repeat="row in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
                              ...
                              <span class="controls">
                                ...
                                <a href="{{url('/')}}/documents/@{{row.id}}/edit" class="edituser blue"><i class="ti-pencil-alt"></i> Editar</a>
...
app.controller('paginado', function($scope, $http, $window) {
    //Listar Paginas 
    $scope.rows = function() {
        $http.get("{{url('documents_lists')}}").then(function successCallback(response)  {
