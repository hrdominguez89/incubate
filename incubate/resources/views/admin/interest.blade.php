...
<div class="content-area">
   <div class="breadcrumb-bar">
      <div class="page-title">
         <h1><i class="ti-briefcase"></i> Intereses</h1>
      </div>
...
<script type="text/javascript">
  ...
  app.controller('species', function($scope, $http, $window) {
    $scope.titulo = "Nuevo interés";
    $scope.btn = "Guardar";
    $scope.rows = function() {
      $http.get('{{url("interests_lists")}}').then(function successCallback(response)   {
    ...
    $scope.asignarValor = function(id,name,name_en) {
      ...
      $("#name").val(name);
      $("#name_en").val(name_en);
      $scope.titulo = "Actualizá tu interés";
      $scope.btn = "Guardar";
    }
  });
  $('#navsm').sortable({
        ...
        update: function() {
            ...
            $.post("{{url('move-interests')}}", order, function(theResponse) {
