               ...
               <div class="col s12">
                  <div class="widget z-depth-1">
                     <div class="widget-title">
                        <h3><i class="ti-pencil"></i> Actualizá la información de tu noticia aquí</h3>
                     </div>
                     <div class="widget-content">
                        <div class="input-field col s12">
                           ...
                           <div class="demo">
                              <input type="checkbox" id="c-<?php echo $rs->id;?>" name="categories[]" @if(strpos($post->categories,",".$rs->id)!== false) checked="checked" @endif value="<?php echo $rs->id;?>">
                  ...
                  <div class="widget z-depth-1">
                     ...
                     <div class="widget-content">
                        ...
                        <div class="input-field col s12 sect-image">
                           ...
                           <input name="image" id="image" value="{{$post->image}}" type="hidden">
...
<script type="text/javascript">
   ...
   app.controller('paginas', function($scope, $http) {
     $scope.rows = function() {
       $scope.data = [];
       $http.post("{{url('/')}}/lists-photo-post", {
         'id': <?=$post->id;?>
       })
     ...
     $scope.borrar = function(name) {
       ...
       function() {
         var route = "{{url('delete-photo-post')}}";
         var token = $("#token").val();
         var image = $("#image").val();
         var patron = "," + name;
    ...
    $scope.rows_archives = function() {
        $http.get('<?php echo url('/');?>/posts_archives_lists/<?php echo $post->id;?>').then(function successCallback(response) {
