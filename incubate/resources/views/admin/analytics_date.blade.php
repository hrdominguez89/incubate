...
<div class="breadcrumb-bar">
   ...
   <div class="widgets-wrapper" ng-app="myApp" ng-controller="paginado">
      ...
      <div class="row">
           <div class="col s12">
            <br>
             <a  class="btn orange" target="_blank"  href="<?php echo url('/');?>/pdf/analytics/<?php echo date('d-m-Y',strtotime($init));?>/<?php echo date('d-m-Y',strtotime($end));?>" style="height: 45px;line-height: 50px; border-radius: 0.3rem;background-color: #33b56a!important;"><i class="fa fa-file-pdf-o aria-hidden="true"></i> Descargá PDF</a>
         <br><br>
      </div>
...
¿Qué páginas visitan sus usuarios?</h3>
               </div>
                   <div class="widget-content">
