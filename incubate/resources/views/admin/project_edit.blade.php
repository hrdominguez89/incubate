               ...
               <div class="col s12">
                  <div class="widget z-depth-1">
                     <div class="widget-title">
                        <h3><i class="ti-pencil"></i> Actualizá el contenido de tu proyecto aquí</h3>
                     </div>
                     <div class="widget-content">
                        <div class="input-field col s12">
                           ...
                           <div class="demo">
                              <input type="checkbox" id="c-<?php echo $rs->id;?>" name="categories[]" @if(strpos($project->categories,",".$rs->id)!== false) checked="checked" @endif value="<?php echo $rs->id;?>">
                     ...
                     <div class="widget-content">
                        ...
                        <div class="input-field col s12 sect-image">
                          <p>Imágenes (740px x 480px)</p>
                           <input name="image" id="image" value="{{$project->image}}" type="hidden">
...
<script type="text/javascript">
   ...
   app.controller('paginas', function($scope, $http) {
     $scope.rows = function() {
       $scope.data = [];
       $http.post("{{url('/')}}/lists-photo-project", {
         'id': <?=$project->id;?>
       })
     ...
     $scope.borrar = function(name) {
       ...
       function() {
         var route = "{{url('delete-photo-project')}}";
         var token = $("#token").val();
         var image = $("#image").val();
         var patron = "," + name;
    ...
    $scope.rows_archives = function() {
        $http.get('<?php echo url('/');?>/projects_archives_lists/<?php echo $project->id;?>').then(function successCallback(response) {
