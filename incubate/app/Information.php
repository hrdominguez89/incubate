...
class Information extends Model {
     ...
     * @var array
     */
    protected $fillable = ['title','url','content','title_en','url_en','content_en','image','status','position','category','resume','resume_en','type','video','boton_name','boton_name_en','subtitle','subtitle_en'];
    /**
     * Set title attribute
     * @param type $value
     */
